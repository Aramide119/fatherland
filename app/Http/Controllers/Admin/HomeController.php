...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'No Of Registered Users',
            'chart_type'            => 'bar',
        ...
        $settings2 = [
            'chart_title'           => 'Travel Orders',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\TravelOrder',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-4',
            'entries_number'        => '5',
            'translation_key'       => 'travelOrder',
        ];

        $chart2 = new LaravelChart($settings2);

        $settings3 = [
            'chart_title'           => 'Event Orders',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\EventOrder',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-4',
            'entries_number'        => '5',
            'translation_key'       => 'eventOrder',
        ];

        $chart3 = new LaravelChart($settings3);

        $settings4 = [
            'chart_title'           => 'No of Restaurants',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
        ...
        $settings7 = [
            'chart_title'        => 'Product Categories',
            'chart_type'         => 'pie',
            'report_type'        => 'group_by_string',
        ...
        return view('home', compact('chart1', 'chart2', 'chart3', 'chart4', 'chart7', 'settings5', 'settings6'));
    }
}
