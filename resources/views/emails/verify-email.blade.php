    ...
    <main style="margin-left: 20px; margin-right: 20px; width: auto; min-height: 640px; display: flex; flex-direction: column; background-color: #FFFFFF;">
        ...
        <section style="height: 118px; margin-left: 24px; margin-right: 24px; margin-top: 32px;">
            ...
            <p
                ...
                Please use the OTP code below to complete your account setup</p>
        ...
        <section style="margin-top: auto;">
            ...
            <div
                ...
                <div style="text-align: right; padding-right: 35px; margin-left: auto;">
                    <p>
                        {{-- <img src="https://res.cloudinary.com/ddodxtt8f/image/upload/v1706277517/facebook-box-line_qmxlmx.png" alt="" style="height: 17px; width: 17px; flex-shrink: 0;">
                        <img src="https://res.cloudinary.com/ddodxtt8f/image/upload/v1706277517/instagram-line_kwrtfc.png" alt="" style="height: 18px; width: 17px; flex-shrink: 0;">
                        <img src="https://res.cloudinary.com/ddodxtt8f/image/upload/v1706277798/linkedin-box-line_zlq5aw.png" alt="" style="height: 17px; width: 17px; flex-shrink: 0;"> --}}
