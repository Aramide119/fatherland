                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        Congratulations on Promoting Your Post!
                                        </strong></p>

                                        <p style="color: #000">
                                        You have successfully promoted your post. Here are the details: <br>
                                        - Amount Paid: NGN{{ $amountPaid }} <br>
                                        - Promotion Duration: {{ $duration }}<br>
                                        - End Date : {{ $daysDue }}
                                        </p>
