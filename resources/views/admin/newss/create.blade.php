...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.newss.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="news_content">{{ trans('cruds.news.fields.content') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('news_content') ? 'is-invalid' : '' }}" name="news_content" id="news_content">{!! old('news_content') !!}</textarea>
