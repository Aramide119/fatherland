...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductVariation">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\ProductVariation::SIZE_SELECT as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-ProductVariation:not(.ajaxTable)').DataTable({ buttons: dtButtons })
