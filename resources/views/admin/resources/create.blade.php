...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.resources.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="content">{{ trans('cruds.resource.fields.content') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.resource.fields.content_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="image">{{ trans('cruds.resource.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.resource.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="video">{{ trans('cruds.resource.fields.video') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.resource.fields.video_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="category">{{ trans('cruds.resource.fields.category') }}</label>
                <select class="form-control {{ $errors->has('resource_category_id') ? 'is-invalid' : '' }}" name="resource_category_id" id="category" required>
                    <option value disabled {{ old('resource_category_id', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach (App\Models\ResourceCategory::getCategorySelect() as $key => $value)
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\Resource::STATUS_SELECT as $key => $label)
