...
<div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route("admin.coaching-videos.update", [$video->id]) }}" enctype="multipart/form-data" id="categoryForm">
        @method('PUT')
        @csrf
        <div class="form-group">
            ...
            <select class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category" id="category" required>
                    <option value="{{ $video->learning_category->id }}">
            ...
            <div class="form-group">
              ...
              <select class="form-control {{ $errors->has('coach') ? 'is-invalid' : '' }}" name="coach" id="coach" required>
                    <option value="{{ $video->coach->id }}">{{ $video->coach->name }}</option>
              </select>
