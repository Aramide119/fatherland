    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="text" name="discount" id="location" value="{{ old('discount', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('event_category_id') ? 'is-invalid' : '' }}" name="event_category_id" id="category" required>
                    <option value disabled {{ old('event_category_id', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach (App\Models\EventCategory::getCategorySelect() as $key => $value)
