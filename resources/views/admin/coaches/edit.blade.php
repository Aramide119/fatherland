...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} Coach Status
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.coaches.update", [$coach->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.event.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $coach->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('biography') ? 'is-invalid' : '' }}" name="biography" id="biography" required>{{ old('biography', $coach->biography) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('learning_category_id') ? 'is-invalid' : '' }}" name="learning_category_id" id="category" required>
                    ...
                    <option value="{{ $key }}" {{ old('learning_category', $coach->learning_category_id) === (string) $key ? 'selected' : '' }}>{{ $value }}</option>
                    @endforeach
                </select>
