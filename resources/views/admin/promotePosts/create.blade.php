...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.promotePosts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" placeholder="15 Days" type="text" name="duration" id="duration" value="{{ old('duration', '') }}" required>
