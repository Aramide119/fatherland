    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.records.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('lineage') ? 'is-invalid' : '' }}" name="lineage" id="lineage">{!! old('lineage') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notable_individual') ? 'is-invalid' : '' }}" name="notable_individual" id="notable_individual">{!! old('notable_individual') !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="profile_picture">{{ trans('cruds.record.fields.profile_picture') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="cover_picture">{{ trans('cruds.record.fields.cover_picture') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_link') ? 'is-invalid' : '' }}" type="text" name="reference_link" id="reference_link" value="{{ old('reference_link', '') }}">
